...
final class TelegramApiMethodRegistry
{
    ...
    private const DEFINITIONS = [
        ...
        'sendVideoNote' => ['required' => ['chat_id', 'video_note'], 'optional' => ['business_connection_id', 'message_thread_id', 'direct_messages_topic_id', 'duration', 'length', 'thumbnail', 'disable_notification', 'protect_content', 'suggested_post_parameters', 'reply_parameters', 'reply_markup', 'ephemeral_message_parameters']],
