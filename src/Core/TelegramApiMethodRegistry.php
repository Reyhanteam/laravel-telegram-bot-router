...
final class TelegramApiMethodRegistry
{
    ...
    private const METHODS = [
        ...
        'getUpdates', 'setWebhook', 'deleteWebhook', 'getWebhookInfo', 'forwardMessage', 'forwardMessages', 'copyMessage', 'copyMessages', 'sendSticker', 'sendChecklist', 'setMessageReaction', 'setChatMemberTag',
        'editMessageText', 'editMessageCaption', 'editMessageMedia', 'editMessageLivePhoto', 'editMessageLiveLocation', 'stopMessageLiveLocation', 'editMessageReplyMarkup', 'editMessageChecklist', 'stopPoll',
        'deleteMessage', 'deleteMessages', 'deleteEphemeralMessage', 'deleteMessageReaction', 'deleteAllMessageReactions', 'getStickerSet', 'getCustomEmojiStickers', 'uploadStickerFile', 'createNewStickerSet', 'addStickerToSet',
        'setStickerPositionInSet', 'deleteStickerFromSet', 'replaceStickerInSet', 'setStickerEmojiList', 'setStickerKeywords', 'setStickerMaskPosition', 'setStickerSetTitle', 'setStickerSetThumbnail', 'setCustomEmojiStickerSetThumbnail',
        'deleteStickerSet', 'answerInlineQuery', 'answerWebAppQuery', 'savePreparedInlineMessage', 'savePreparedKeyboardButton', 'postStory', 'repostStory', 'editStory', 'deleteStory', 'getChatGifts',
        'getBusinessAccountStarBalance', 'transferBusinessAccountStars', 'getBusinessAccountGifts', 'setBusinessAccountName', 'setBusinessAccountUsername', 'setBusinessAccountBio', 'setBusinessAccountProfilePhoto',
        'removeBusinessAccountProfilePhoto', 'setBusinessAccountGiftSettings', 'readBusinessMessage', 'deleteBusinessMessages', 'getMyStarBalance', 'getStarTransactions', 'refundStarPayment', 'editUserStarSubscription',
        'getUserGifts', 'transferGift', 'convertGiftToStars', 'upgradeGift', 'getMyShortDescription', 'setMyProfilePhoto', 'removeMyProfilePhoto', 'setChatMenuButton', 'getChatMenuButton',
        'setMyDefaultAdministratorRights', 'getMyDefaultAdministratorRights', 'getAvailableGifts', 'giftPremiumSubscription', 'verifyUser',
    ];
    ...
    private const DEFINITIONS = [
        ...
        'sendAnimation' => ['required' => ['chat_id', 'animation'], 'optional' => ['business_connection_id', 'message_thread_id', 'direct_messages_topic_id', 'duration', 'width', 'height', 'thumbnail', 'caption', 'parse_mode', 'caption_entities', 'show_caption_above_media', 'has_spoiler', 'supports_streaming', 'disable_notification', 'protect_content', 'allow_paid_broadcast', 'message_effect_id', 'suggested_post_parameters', 'reply_parameters', 'reply_markup', 'ephemeral_message_parameters']],
        'sendVoice' => ['required' => ['chat_id', 'voice'], 'optional' => ['business_connection_id', 'message_thread_id', 'caption', 'parse_mode', 'caption_entities', 'duration', 'disable_notification', 'protect_content', 'allow_paid_broadcast', 'message_effect_id', 'suggested_post_parameters', 'reply_parameters', 'reply_markup', 'ephemeral_message_parameters']],
        'sendVideoNote' => ['required' => ['chat_id', 'video_note'], 'optional' => ['business_connection_id', 'message_thread_id', 'duration', 'length', 'thumbnail', 'disable_notification', 'protect_content', 'suggested_post_parameters', 'reply_parameters', 'reply_markup', 'ephemeral_message_parameters']],
        ...
        'unpinChatMessage' => ['required' => ['chat_id'], 'optional' => ['message_id', 'business_connection_id']],
        ...
        'editMessageText' => ['required' => [], 'optional' => ['chat_id', 'message_id', 'text', 'inline_message_id', 'business_connection_id', 'parse_mode', 'entities', 'link_preview_options', 'rich_message', 'reply_markup']],
        'editMessageCaption' => ['required' => [], 'optional' => ['chat_id', 'message_id', 'caption', 'inline_message_id', 'business_connection_id', 'parse_mode', 'caption_entities', 'show_caption_above_media', 'reply_markup']],
        'editMessageMedia' => ['required' => ['media'], 'optional' => ['chat_id', 'message_id', 'inline_message_id', 'business_connection_id', 'reply_markup']],
        'editMessageLivePhoto' => ['required' => ['media'], 'optional' => ['chat_id', 'message_id', 'inline_message_id', 'business_connection_id', 'reply_markup']],
        'editMessageLiveLocation' => ['required' => ['latitude', 'longitude'], 'optional' => ['chat_id', 'message_id', 'inline_message_id', 'business_connection_id', 'live_period', 'horizontal_accuracy', 'heading', 'proximity_alert_radius', 'reply_markup']],
        'stopMessageLiveLocation' => ['required' => [], 'optional' => ['chat_id', 'message_id', 'inline_message_id', 'business_connection_id', 'reply_markup']],
        'editMessageReplyMarkup' => ['required' => [], 'optional' => ['chat_id', 'message_id', 'inline_message_id', 'business_connection_id', 'reply_markup']],
